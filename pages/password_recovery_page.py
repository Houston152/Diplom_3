...
from locators.locators_recovery_password_page import PasswordRecoveryPageLocators
...
class PasswordRecoveryPage(BasePage):
    ...
    @allure.step('Ввод email в поле ввода Email')
    ...
    @allure.step('Нажать на иконку в инпуте для показа или скрытия пароля')
    ...
    @allure.step('Проверить, что после клика по инпуту для ввода нового пароля он стал активен')
